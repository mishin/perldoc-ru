...
perlperf - Методы оптимизации производительности Perl

Это введение в использование производительности и оптимизации методов, 
которые могут быть использованы с особым упором на программы на perl.
Хотя многие разработчики perl пришли из других языков и можно использовать 
их предварительных знаний, где это уместно, есть много других людей, 
которые могут воспользоваться несколько конкретных советов perl. 
Если вы хотите сокращенный вариант, возможно лучший совет исходит 
от известного японского самурая, Миямото Мусаси, который сказал:
«Не заниматься бесполезной деятельностью»
