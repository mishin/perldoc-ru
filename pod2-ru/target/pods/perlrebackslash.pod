...
perlrebackslash - регулярных выражения Perl и последовательности с обратной косой чертой (Backslash Sequences) и Escapes
...
у вас есть включены предупреждения (use warnings), Perl выдает предупреждение, если вы используете такую
последовательность. [1].

Однако, гарантируется, что последовательности обратной косой черты или эскейп никогда не будут иметь
знака препинания после обратной косой черты, не сейчас, не в будущих
