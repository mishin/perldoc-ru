...
В данном положении символов, первая альтернатива позволяет
успешно найти регекс, это первое, что будет найдено. чтобы преуспеть будет тем, который соответствует. Здесь, весь
альтернативы соответствуют в первом положении последовательности, таким образом, первые матчи.
