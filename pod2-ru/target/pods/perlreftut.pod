...
=head1 ОПИСАНИЕ
   ...
   позволяет работать со сложной, структурированной информацией. Однако, к
   сожалению, для этого приходится изучать довольно сложный синтаксис, и
   будет сложно следовать основному руководству.
...
=item * Иван Рак C<< <rak@tut.by> >> http://www.opennet.ru/base/dev/perlreftut_ru.txt.html
