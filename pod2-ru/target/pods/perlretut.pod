...
Со всеми регекспами выше, если регексп находит соответствие в любой точке строки,
то он считается найденным. Иногда однако, мы хотели бы
указать I<где> в строке регексп должен искать.
Для этого Чтобы указать где он должен быть найден, 
мы будем использовать якорем метасимволы ^ и $. 
Якорь ^ означает поиск в начале строки , а якорь $ означает поиск 
