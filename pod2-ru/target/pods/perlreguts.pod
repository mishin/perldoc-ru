...
Этот документ представляет собой попытку, чтобы сиять некоторый свет на кишки regex
двигатель и как она работает. Regex engine представляет значительный кусок
perl кодовой базы, но это относительно плохо понимает. Этот документ
это скудные попытка в урегулировании этой ситуации. Он является производным от
опыт автора, комментарии в исходном коде, другие документы на
Regex двигатель, обратной связи на список рассылки perl5-носильщиков и без сомнения других
мест, а также.
