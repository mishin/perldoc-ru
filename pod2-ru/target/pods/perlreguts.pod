...
B <NOTICE!> он должен быть четко поняли, что поведение и
структуры, обсуждали в этом представляет состояние двигателя как
Автор понимает это на момент написания. Это B <NOT>API
