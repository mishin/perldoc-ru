...
символу, за исключением новой строки. Это значение по умолчанию можно изменить на
Добавить сопоставление строки с помощью I модификатора < одной строки настроек: либо
для всего регулярного выражения с C</s> модификатор, или
локально с C <(?s)>. (C <\N> последовательности обратной косой черты, описанные
ниже, соответствует любому символу, за исключением новой строки без связи с
Я < одной строки настроек модификатор.)
