...
perlhacktut - Легкая прогулка по созданию патча для C кода.

=head1 ОПИСАНИЕ

Этот документ проведет вас через простой пример патча.

Если вы еще не читали L<perlhack> , сделайте это в первую очередь! Вы также могли бы прочитать L<perlsource>.
