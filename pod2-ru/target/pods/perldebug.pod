...
perldebug - отладка в Perl (или нахождение и устранение дефектов)

=head1 ОПИСАНИЕ

Прежде всего, вы пытались использовать ключ B<-w>?

Если вы новичок в Perl отладке, вам лучше почитать
L<perldebtut>, который представляет собой учебник по введению в отладчик.
