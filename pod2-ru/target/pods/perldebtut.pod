...
Это очень упрощенное введение в использование perl отладчика и
указатель на существующие, более подробные источники информации по вопросу отладки
программы на Perl.

Существует чрезвычайно большое число людей, которые не представляют себе ничего
об отладчике perl, хотя они используют язык каждый день.
Это для них.
