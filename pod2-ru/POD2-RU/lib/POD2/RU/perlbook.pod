...
=item I<Perl Best Practices> I<Perl Лучшие Практики>

	by Damian Conway
	ISBN: 978-0-596-00173-5 [1st edition July 2005]
	http://oreilly.com/catalog/9780596001735

=item I<Higher-Order Perl> I<Perl Высших порядков, примеры функционального программирования на Perl, там речь идет о функциях, которые могут модифицировать и производить другие функции.>

	by Mark-Jason Dominus
	ISBN: 1-55860-701-3 [1st edition March 2005]
	http://hop.perl.plover.com/

=item I<Mastering Regular Expressions> I<Освоение
...
=item I<Network Programming with Perl> I<Сетевое программирование в Perl>
...
=item I<Object Oriented Perl> I<Объектно-ориентированный Perl>
...
=item I<Data Munging with Perl> I<Манипулирование (Munging) данными в Perl>
...
=item I<Extending and Embedding Perl> I<Расширения и встраивания Perl>

	by Tim Jenness and Simon Cozens
	ISBN 1-930110-82-0 [1st edition August 2002]
	http://www.manning.com/jenness

=item I<Pro Perl Debugging> I<Профессиональная отладка Perl>
...
=head2 бесплатно (как в пиве) книги
...
=item I<Programming Pearls> I<Жемчуг программирования>
